        ...
        if (!isset($_GET['brand'])) {
            ...
            <div class='card'>
                ...
                <div class='card-body'>
                    ...
                    <a href='product_deteails.php?product_id=$product_id' class='btn btn-secondary'>Ürüne bak</a>
                </div>
            </div>
        </div>";
            }
...
function search_product()
{
    ...
    if (isset($_GET['search_data_product'])) {
        ...
        mysqli_stmt_bind_param($stmt, "s", $search_data_value);
 ...
 function cart(){
    if(isset($_GET['add_to_cart'])){
        ...
        if($num_of_rows > 0){
            ...
            echo "<script>alert('Üürün Sepete Eklendi')</script>";
            echo "<script>window.open('index.php','_self')</script>";
        }
    }
}
...
// functions/common_function.php dosyanızda
function check_admin_login($admin_name, $admin_password) {
    global $con; // $con değişkeninizi tanımladığınızdan emin olun


    $query = "SELECT * FROM admin WHERE admin_name = ? LIMIT 1";
